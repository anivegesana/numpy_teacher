...
PY_150_PATH = "C:/Users/achan/OneDrive/Documents/GradSchool/FA22/CS329M/numpy_teacher/gpt2/datasets/py150"


# Returns a dataset with shape (n_files, n_rows_in_file)
def dataset_loader(mode="amazing_python", split="train") -> List[List[str]]:
